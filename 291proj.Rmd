                                         ...
                                         ifelse(RACE == 7,"other race",
                                                ifelse(RACE == 4, "chinese", 
                                                       ifelse(RACE == 5, "japanese",
                                                              ifelse(RACE == 6, "asian/pac islander",
                                                                     ifelse(RACE == 8, "2 or more",
                                                                            ifelse(RACE == 9, "3 or more",0))))))))))
...
summary(m14)
m15 <- glm(internet~TRANTIME+HHINCOME+AGE + as.factor(PHONE)+as.factor(race_int)+as.factor(DIFFEYE), data=samp, family=binomial)
summary(m15)
